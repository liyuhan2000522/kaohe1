...
//             parent.layer.close(index); //再执行关闭
    ...
    function mycheck(){
    debugger;
        var daoHangTitle = $("#daoHangTitle").val();
        if(isNull(daoHangTitle)){
            alert("标题不可为空！");
            return false;
        }
        var daoHangUrl = $("#daoHangUrl").val();
        if(isNull(daoHangUrl)){
            alert("路径不可为空！");
            return false;
        }
                            ...
                            <form name="form1" id="newsForm" action="${pageContext.request.contextPath}/daoHang" method="post" accept-charset="UTF-8" onSubmit="return mycheck()">
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        ...
                                        <td width="300" align="left"><input type="text" name="daoHangTitle" id="daoHangTitle" class="text1" /></td>
                                    </tr>
                                    <tr>
                                        <td height="30" align="right" class="STYLE2">网址路径：</td>
                                        <td align="left"><input type="text" name="daoHangUrl" id="daoHangUrl" class="text1" /></td>
                                    </tr>
                                    <tr>
